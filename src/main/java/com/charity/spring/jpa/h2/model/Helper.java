...
public class Helper {
    ...
    public Helper(long id, String title, String description, String address, String link, double coords1, double coords2, String phone, String picture, Integer cost) {
        this.id = id;
        this.title = title;
